...
dekk provides these types. Consumers implement them.
dekk itself never imports or executes any implementation.
"""
...
class DetectedIssue:
    ...
    This is the bridge between detection (pure dekk) and remediation (consumer code).
    """
