...
from dekk.skills.constants import SKILLS_COMMAND_GENERATE
from dekk.tools import SKILLS as PROJECT_SKILLS_COMMAND
...
Regenerate with: dekk {project_name} {PROJECT_SKILLS_COMMAND} {SKILLS_COMMAND_GENERATE}
\"\"\"
