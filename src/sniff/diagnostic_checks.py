...
These checks use existing sniff detectors (PlatformDetector, DependencyChecker,
...
from sniff.detect import PlatformDetector
from sniff.deps import DependencyChecker, DependencySpec
...
class PlatformCheck:
    ...
    def description(self) -> str:
        return "Detect OS, architecture, and container/WSL status"
...
class CIEnvironmentCheck:
    ...
    @property
    def description(self) -> str:
        return "Detect CI/CD provider and build metadata"
    ...
    def run(self) -> CheckResult:
        ...
        provider_name = info.provider.display_name if info.provider else "Unknown CI"
