...
formatted environment information using the sniff unified styling system.
"""
...
from sniff.cli.styles import console, print_section, print_table
...
def run_doctor(context: ExecutionContext) -> None:
    ...
    using the sniff unified styling system.
