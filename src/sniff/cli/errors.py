"""Structured error handling for sniff CLI applications.
...
Usage::
    ...
    from sniff.cli.errors import NotFoundError, ValidationError
...
class SniffError(Exception):
    """Base exception for sniff CLI errors.

    All sniff exceptions carry:
