...
formatted environment information using the sniff-cli unified styling system.
"""
...
from sniff_cli.cli.styles import console, print_section, print_table
...
def run_doctor(context: ExecutionContext) -> None:
    ...
    using the sniff-cli unified styling system.
