...
from sniff_cli.build import BuildSystem, BuildSystemDetector
from sniff_cli.cli.errors import NotFoundError, RuntimeError
...
DOCTOR_HINT: Final = "Run 'sniff doctor' to diagnose the environment"
...
def run_test_plan(plan: TestPlan) -> int:
    ...
    if spec_file is not None:
        ...
        from sniff_cli.cli.errors import DependencyError
