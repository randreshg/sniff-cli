"""Unified styling and output functions for sniff-cli CLI applications.
...
Usage::
    ...
    from sniff_cli.cli.styles import print_success, print_error, print_info, Colors
...
def __getattr__(name: str):  # noqa: N807
    ...
    if name == "CLI_THEME":
        ...
        return val
    raise AttributeError(f"module 'sniff_cli.cli.styles' has no attribute {name!r}")
