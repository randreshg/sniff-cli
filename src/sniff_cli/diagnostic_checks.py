...
These checks use existing sniff-cli detectors (PlatformDetector, DependencyChecker,
...
from sniff_cli.deps import DependencyChecker, DependencySpec
from sniff_cli.ci import CIDetector
from sniff_cli.diagnostic import CheckResult, CheckStatus
