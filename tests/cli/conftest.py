"""Shared fixtures for dekk CLI tests.

Provides console capture helpers that patch dekk.cli.styles internals
...
def _patch_console(*, stderr: bool = False, highlight: bool = True, extra_targets=None):
    """Context manager that patches dekk.cli.styles console singletons.
