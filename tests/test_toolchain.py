...
from sniff.shell import ActivationConfig, ActivationScriptBuilder, EnvVar, ShellKind
...
class TestCMakeToolchain:
    ...
    @patch("sniff.toolchain.platform.system", return_value="Linux")
    ...
    @patch("sniff.toolchain.platform.system", return_value="Darwin")
